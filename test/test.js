...
exercise.forEach(function(exerciseMode) {
  ...
  // suite that calculates the average time it takes to call .json() on a response

  suite('Response.json() performance', function() {
    var jsonTime = 0
    var iterations = 100
    var url = '/largerandomjson'
    ...
    test('average time', function() {
      console.log('Average time to call .json() on a response:', jsonTime / iterations, 'ms')
    })
  })
})
